...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "BARUNA — Marine & Fisheries Knowledge Network" },
      {
        name: "description",
        content:
          "BARUNA connects people, knowledge, and opportunities to strengthen capacity and drive sustainable marine and fisheries development.",
      },
      { name: "author", content: "BARUNA" },
      ...
      { name: "twitter:site", content: "@BARUNA" },
    ],
    links: [
